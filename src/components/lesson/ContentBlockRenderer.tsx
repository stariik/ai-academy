...
export function ContentBlockRenderer({
  ...
  return (
    <div ref={ref} id={`block-${block.id}`} className="mb-6">
      ...
      {block.type === 'callout' && (
        <div className="rounded-lg border-l-4 border-amber-400 bg-amber-50 p-4" role="note">
      ...
      {block.type === 'warning' && (
        <div className="rounded-lg border-l-4 border-red-400 bg-red-50 p-4" role="alert">
      ...
      {block.type === 'tip' && (
        <div className="rounded-lg border-l-4 border-green-400 bg-green-50 p-4" role="note">
