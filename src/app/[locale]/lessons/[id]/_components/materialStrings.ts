...
export const MATERIAL_STRINGS: Record<MaterialLocale, MaterialStrings> = {
  ka: {
    ...
    lockedHint: 'ისაუბრე Walle-სთან მასალაზე — როცა მზად იქნები, ის გახსნის შემდეგ ეტაპს.',
  ...
  en: {
    ...
    lockedHint: "Talk through the material with Walle — when you're ready, it'll unlock the next step.",
